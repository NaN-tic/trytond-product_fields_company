...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-product_fields_company',
    download_url='https://github.com:nantic/trytond-product_fields_company.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-product_fields_company.git'
    },
    classifiers=[
